...
def main():
    ...
    # model_name = "vllm/Qwen/Qwen3-4B-Instruct-2507"
    # model_name = "openrouter/openai/gpt-oss-safeguard-20b"
    # model_name = "openrouter/openai/gpt-4o-2024-08-06"
    model_name = "openrouter/openai/gpt-5.1"
    # model_name = "openrouter/microsoft/phi-3-medium-128k-instruct"

    if args['seed-events']:
        seed_events(genres, 2, model_name)
    elif args['seed-summaries']:
        seed_summaries(model_name, num_summaries=2)
